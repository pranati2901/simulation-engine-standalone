...
LLM directly. The model writes the SPEC (fault, decision gate, cascade edges); the
authoring service validates every reference against the domain catalog, assembles a
Scenario deterministically, registers it, and returns it — immediately runnable.
"""
